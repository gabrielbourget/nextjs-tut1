...
// const createTodo = async (date: FormData) => {
//   "use server";
  ...
  return (
    <>
      ...
      <form className="flex gap-2 flex-col" action={createTodo}>
        <input type="text" name="title" className="border border-slate-300 bg-transparent text-slate-300 px-2 py-1 rounded hover:bg-slate-700 focus-within:bg-slate-700 focus-within:border-slate-100 outline-none"/>
